...
const Credencializacion = () =>{
    ...
    const getDatosCredencial=()=>{
        const rta=axios.get('http://https://linxco-backend.herokuapp.com/api/v1/tramites/credenciales/factura/'+matriculaAlumno)
            .then(res=>{
    ...
    const addCredencial= async ()=>{
        ...
        const rta= await  axios.post('http://https://linxco-backend.herokuapp.com/api/v1/tramites/credencial',dta)
    ...
    const editCredencial=()=>{
        ...
        axios.defaults.headers.Authorization = "Bearer " + cookie;
        const res = axios
            .patch("http://https://linxco-backend.herokuapp.com/api/v1/factura/"+factura.id_factura, data);
