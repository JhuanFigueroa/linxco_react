...
const BajasForm = () => {
    ...
    const getRazones=async ()=>{
        const rta=await axios.get('http://https://linxco-backend.herokuapp.com/api/v1/bajas/razones');
        setRazones(rta.data)
    }
    ...
    const handleClick=()=>{
        ...
        const rta=axios.post('http://https://linxco-backend.herokuapp.com/api/v1/bajas',data)
            .then(function (response){
                ...
                axios.defaults.headers.Authorization = "Bearer " + cookie;
                const res=axios.post('http://https://linxco-backend.herokuapp.com/api/v1/baja-alumno',dta)
                razonBaja.map(razon=>{
                    const dtaRazobBaja={
                        'idBaja':idB,
                        'claveRazon':razon
                    ...
                    const cookie = Cookie.get("token");
                    axios.defaults.headers.Authorization = "Bearer " + cookie;
                    axios.post('http://https://linxco-backend.herokuapp.com/api/v1/bajas/razones',dtaRazobBaja)
                })
            })
